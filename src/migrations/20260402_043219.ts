...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  await db.run(sql`DROP TABLE IF EXISTS \`__new__posts\`;`)
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_posts\`("id", "title", "content", "meta_title", "meta_image_id", "meta_description", "cover_image_id", "facebook_url", "published_at", "generate_slug", "slug", "updated_at", "created_at", "_status") SELECT "id", "title", "content", "meta_title", "meta_image_id", "meta_description", "cover_image_id", "facebook_url", "published_at", "generate_slug", "slug", "updated_at", "created_at", "_status" FROM \`posts\`;`)
  ...
  `)
  // _posts_v contient des FK invalides — on repart d'un historique vide
  // Les posts publiés (table posts) sont préservés intégralement
